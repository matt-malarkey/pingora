...
use crate::protocols::{Digest, GetProxyDigest, GetSocketDigest, GetTimingDigest, SocketAddr, Ssl};
use crate::utils::{BufRef, KVRef};

use crate::listeners::l4::{Stream as L4Stream};

/// The HTTP 1.x server session
pub struct L4HttpSession {
    underlying_stream: L4Stream,
...
impl L4HttpSession {
    ...
    pub fn new(underlying_stream: L4Stream) -> Self {
    ...
    /// returned.
    pub async fn reuse(mut self) -> Option<L4Stream> {
